...
char transpose_submit_desc1[] = "trans_1";
...
char transpose_submit_desc2[] = "trans_2";
...
char transpose_submit_desc3[] = "trans_3";
...
void registerFunctions()
{
	...
	registerTransFunction(trans_1, transpose_submit_desc1); 
    registerTransFunction(trans_2, transpose_submit_desc2); 
    registerTransFunction(trans_3,transpose_submit_desc3);
